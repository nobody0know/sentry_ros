...
void callback(const sensor_msgs::ImageConstPtr & src_msg, const robot_msgs::visionConstPtr &imu_msg)
{
    ...
    cv::putText(src,"predicted_position",cv::Point2f(640 - 200,1024 - 150),cv::FONT_HERSHEY_SIMPLEX,1,cv::Scalar(255,255,0),1,3);
    cv::putText(src,"x  : "+std::to_string(Track.predicted_position[0]),cv::Point2f(640 - 200,1024 - 120),cv::FONT_HERSHEY_SIMPLEX,1,cv::Scalar(255,255,0),1,3);
    cv::putText(src,"y  : "+std::to_string(Track.predicted_position[1]),cv::Point2f(640 - 200,1024 - 90),cv::FONT_HERSHEY_SIMPLEX,1,cv::Scalar(255,255,0),1,3);
    cv::putText(src,"z  : "+std::to_string(Track.predicted_position[2]),cv::Point2f(640 - 200,1024 - 60),cv::FONT_HERSHEY_SIMPLEX,1,cv::Scalar(255,255,0),1,3);
