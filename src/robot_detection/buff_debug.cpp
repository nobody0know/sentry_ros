...
// 	cv::VideoCapture cap;
// 	cap.open("/home/hanjiang/rune_test.mp4"); 
...
int main()
{
	...
	capture.open("/home/hanjiang/rune_test.mp4");
	if (!capture.isOpened()) {
	...
	VideoWriter writer("/home/hanjiang/rune_test_2.mp4", CAP_OPENCV_MJPEG, fps, S, true);
