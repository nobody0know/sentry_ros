...
if("TRUE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /home/lxj/sentry_ros/src/hardware_interface)
  set(hardware_interface_DEVEL_PREFIX /home/lxj/sentry_ros/devel)
  ...
  set(hardware_interface_INSTALL_PREFIX /home/lxj/sentry_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'lxj <lxj@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lxj/sentry_ros/src/hardware_interface/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lxj/sentry_ros/devel/lib;/opt/ros/noetic/lib)
